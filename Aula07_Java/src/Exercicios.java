...
public class Exercicios {
    ...
    public static void ex04() {
        ...
        Jogador j1 = new Jogador("Xampson", 1000, 4);
        Jogador j2 = new Jogador("Alguem", 10000, 40);
    ...
    public static void ex06() {
        ...
        /*
         * EXERCÍCIO 06 (BÔNUS):
         * Inspirado pela organização de um grande evento de networking, onde os
         * participantes trocam contatos e informações profissionais, um desenvolvedor
         * decide criar um sistema para gerenciar uma agenda de contatos. Este sistema
         * ajudará os usuários a manter suas conexões organizadas, permitindo-lhes
         * adicionar, remover e buscar contatos facilmente.
         * Dica:
         * “Crie as classes Agenda e Contato em Java. A classe Contato deve armazenar
         * informações como nome e telefone, enquanto a classe Agenda deve gerenciar uma
         * lista de contatos, com métodos para adicionar novos contatos, remover
         * contatos existentes e buscar contatos por nome. Este exercício reforça o uso
         * de coleções em Java, além de aplicar os princípios de encapsulamento e
